...
def generate_answer(question, content, openai_gpt_api_base, openai_gpt_api_key, openai_gpt_api_version, openai_gpt_model):  
    ...
    At the end of your response use markdown format to display links of the format ![imgname.png](url) to the source images for each source you used to answer the question.
